Shader "Marvel/Lightmap-Self-Illum-Tex"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings IN) : SV_Target
            {
                ...
                float4 lightmapTex = SAMPLE_TEXTURE2D(_LightMap, sampler_LightMap, IN.uv2);
                ...
                float3 finalColor = (lighting + lightmapTex.rgb) * mainTex.rgb * _Color.rgb + emission;
