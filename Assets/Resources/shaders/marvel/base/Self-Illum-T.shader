    ...
    SubShader {
        ...
        Pass {
            ...
            Varyings vert(Attributes input) {
                ...
                output.illumUV = TRANSFORM_TEX(input.uv, _Illum);
            ...
            half4 frag(Varyings input) : SV_Target {
                ...
                half4 illumTex = SAMPLE_TEXTURE2D(_Illum, sampler_Illum, input.illumUV);
                
                // Combinar texturas
                half4 col = mainTex * _Color;
                col.rgb = lerp(col.rgb, col.rgb * illumTex.rgb, illumTex.a);
