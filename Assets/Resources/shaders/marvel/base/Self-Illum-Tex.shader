// Alejandro -> cambio a sintaxis URP. Shader autoiluminado con textura y soporte para lightmaps.
// WARNING: La autoiluminación a veces se ve muy brillante en URP, especialmente con HDR
Shader "Marvel/Base/Self-Illuminated Texture"
{
    Properties {
