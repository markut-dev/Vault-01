// Alejandro -> cambio a sintaxis URP. Shader difuso con textura detallada animada, transparencia y soporte para lightmaps.
Shader "Marvel/Base/Detail Animated Transparent"
{
    Properties {
    ...
    SubShader {
        ...
        Pass {
            ...
            half4 frag(Varyings input) : SV_Target {
                ...
                // Animar UVs de detalle con el tiempo
                float2 detailUV = input.detailUV + _ScrollSpeed * _Time.y;
                
                // Muestrear texturas
                half4 mainTex = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, input.uv);
                half4 detailTex = SAMPLE_TEXTURE2D(_DetailTex, sampler_DetailTex, detailUV);
                
                // Combinar texturas con multiplicación para el efecto de detalle
                half4 col = mainTex * detailTex * _Color;
